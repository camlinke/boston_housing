...
def explore_city_data(city_data):
    ...
    print "The number of houses is:"
    print housing_prices.size
    # Number of features?
    print "The number of features is:"
    print housing_features[0].size
    # Minimum price?
    print "The minimum housing price is (note: price is in 1000's)"
    print housing_prices.min()
    # Maximum price?
    print "The maximum housing price is (note: price is in 1000's)"
    print housing_prices.max()
    # Calculate mean price?
    print "The mean housing price is (note: price is in 1000's)"
    print housing_prices.mean()
    # Calculate median price?
    print "The median housing price is (note: price is in 1000's)"
...
def fit_predict_model(city_data):
    ...
    # Nearest Neighbors - code implemented based on reviewer suggestion
